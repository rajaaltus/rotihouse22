    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-96">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <label className="block text-yellow-400 mb-2">Confirm Password</label>
            <input
              type="password"
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-white text-gray-900 py-2 px-4 rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 flex items-center justify-center space-x-2 mb-4"
        >
